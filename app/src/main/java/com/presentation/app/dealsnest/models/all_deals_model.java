...
public class all_deals_model implements Parcelable {
    public static final Creator<all_deals_model> CREATOR = new Creator<all_deals_model>() {
        @Override
        public all_deals_model createFromParcel(Parcel in) {
            return new all_deals_model(in);
        }

        @Override
        public all_deals_model[] newArray(int size) {
            return new all_deals_model[size];
        }
    };
    int count;
    @SerializedName("id")
    ...
    public all_deals_model() {
    }

    protected all_deals_model(Parcel in) {
        id = in.readString();
