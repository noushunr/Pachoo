...
import com.presentation.app.dealsnest.utils.ImageUtils;
...
public class ProfileActivity extends BaseActivity implements View.OnClickListener, ProfileActivityViewInterface {
    ...
    private void GetProfileDetails(String register_id) {
        profileActivityPresenter.loadProfileDetails(register_id);
    }
    ...
    private void UPDATE_PROFILE() {
        ...
        if (isValidated()) {
            profileActivityPresenter.updateProfile(REGISTER_ID_HOLDER, FIRST_NAME_HOLDER, LAST_NAME_HOLDER, EMAIL_ID_HOLDER, MOBILE_HOLDER, image);
        }
